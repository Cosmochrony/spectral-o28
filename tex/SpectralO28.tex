...
\begin{document}
  ...
  \begin{abstract}
    ...
    linear law (it overpredicts $n_1$ by up to $+88\%$) and establishes $n_1(q)/q \to 0$; the asymptotic
    law of $n_1$ otherwise remains open.
  ...
  \subsection{Out-of-sample test: the linear law fails and $n_1(q)/q \to 0$}
    ...
    The asymptotic law of $n_1$ remains open; only the linear scaling hypothesis is excluded.
  ...
  \subsection{What remains open}
    ...
    \begin{itemize}
      \item The asymptotic law of $n_1(q)$: the out-of-sample campaign (now carried to $q = 601$)
      establishes $n_1(q)/q \to 0$ and excludes the linear law, but the sub-linear law itself is open.
      \item Analytical derivation of the exact eigenvalue structure~\eqref{eq:eig_structure}.
    \end{itemize}
  ...
  $n_1(q)/q \to 0$; the linear scaling hypothesis is excluded, the sub-linear law otherwise remaining
  open.
