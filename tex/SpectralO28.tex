...
\begin{document}
  ...
  \begin{abstract}
    ...
    now-proved asymptotic law, and leaves the spin-$\tfrac{1}{2}$ dimension unmeasured by the
  ...
  It fills $H_{\mathrm{eff}} = \mathbb{C}^3$ at the stated threshold, consistent with the supplied
